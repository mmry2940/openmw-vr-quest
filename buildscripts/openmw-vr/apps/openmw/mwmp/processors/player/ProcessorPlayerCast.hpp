    ...
    public:
        ...
        virtual void Do(PlayerPacket &packet, BasePlayer *player)
        {
            if (!isLocal() && player != 0)
            {
                ...
                world->moveObject(playerPtr, osg::Vec3f(dedicatedPlayer.position.pos[0], dedicatedPlayer.position.pos[1], dedicatedPlayer.position.pos[2]));
                world->rotateObject(playerPtr, osg::Vec3f(dedicatedPlayer.position.rot[0], 0.f, dedicatedPlayer.position.rot[2]));
