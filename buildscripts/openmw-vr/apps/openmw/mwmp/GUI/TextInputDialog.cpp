...
namespace mwmp
{
    ...
    void TextInputDialog::setNextButtonShow(bool shown)
    {
        ...
        if (shown)
            okButton->setCaption(std::string(MWBase::Environment::get().getWindowManager()->getGameSettingString("sNext", "")));
        else
            okButton->setCaption(std::string(MWBase::Environment::get().getWindowManager()->getGameSettingString("sOK", "")));
    }
